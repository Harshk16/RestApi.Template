...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=RC-08040;Initial Catalog=EFCOREDBFIRST; Persist Security Info=true; User Id=RARECREW\\harshsharma; pwd=; Integrated Security=SSPI; Trusted_Connection=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCF9675EEFD");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE1E104E75A");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A56AD74075");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F222BD82CE80");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC70856EA2");
